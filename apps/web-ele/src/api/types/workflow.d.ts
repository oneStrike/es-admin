...
export type WorkflowPageRequest = {
  ...
  /* 工作流类型 */
  workflowType?: null | string;
};

export type WorkflowPageResponse = {
  /* 列表数据 */
  list?: null | WorkflowJobDto[];
...
export type WorkflowNotificationListRequest = {
  ...
  kinds?: ('failed' | 'retrying' | 'success')[] | null;
