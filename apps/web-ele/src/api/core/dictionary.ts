...
import { requestClient } from '#/api/request'
   ...
   * 分页获取字典项
   */
  export async function dictionaryItemPageApi(params: DictionaryItemPageRequest): Promise<DictionaryItemPageResponse> {
    return requestClient.get<DictionaryItemPageResponse>('/api/admin/dictionary/item/page', { params });
  }
   ...
   * 获取所有字典项
   */
  export async function dictionaryItemListApi(params: DictionaryItemListRequest): Promise<DictionaryItemListResponse> {
    return requestClient.get<DictionaryItemListResponse>('/api/admin/dictionary/item/list', { params });
  }
   ...
   * 创建字典项
   */
  export async function dictionaryItemCreateApi(params: DictionaryItemCreateRequest): Promise<DictionaryItemCreateResponse> {
    return requestClient.post<DictionaryItemCreateResponse>('/api/admin/dictionary/item/create', params);
  }
   ...
   * 更新字典项
   */
  export async function dictionaryItemUpdateApi(params: DictionaryItemUpdateRequest): Promise<DictionaryItemUpdateResponse> {
    return requestClient.post<DictionaryItemUpdateResponse>('/api/admin/dictionary/item/update', params);
  }
   ...
   * 启用禁用字典项
   */
  export async function dictionaryItemUpdateStatusApi(params: DictionaryItemUpdateStatusRequest): Promise<DictionaryItemUpdateStatusResponse> {
    return requestClient.post<DictionaryItemUpdateStatusResponse>('/api/admin/dictionary/item/update-status', params);
  }
   ...
   * 删除字典项
   */
  export async function dictionaryItemDeleteApi(params: DictionaryItemDeleteRequest): Promise<DictionaryItemDeleteResponse> {
    return requestClient.post<DictionaryItemDeleteResponse>('/api/admin/dictionary/item/delete', params);
  }
   ...
   * 字典项交换排序
   */
  export async function dictionaryItemSwapSortOrderApi(params: DictionaryItemSwapSortOrderRequest): Promise<DictionaryItemSwapSortOrderResponse> {
    return requestClient.post<DictionaryItemSwapSortOrderResponse>('/api/admin/dictionary/item/swap-sort-order', params);
  }
