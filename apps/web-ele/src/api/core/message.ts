 ...
 * 获取消息 outbox 监控摘要
 */
export async function messageMonitorOutboxSummaryApi(
  params?: MessageMonitorOutboxSummaryRequest,
): Promise<MessageMonitorOutboxSummaryResponse> {
  return requestClient.get<MessageMonitorOutboxSummaryResponse>(
    '/api/admin/message/monitor/outbox/summary',
    { params },
  );
}
