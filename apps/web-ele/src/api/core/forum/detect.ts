...
import { requestClient } from '#/api/request'
   ...
   * 获取文本中敏感词的最高等级
   */
  export async function detectHighestLevelApi(params: DetectHighestLevelRequest): Promise<DetectHighestLevelResponse> {
    return requestClient.post<DetectHighestLevelResponse>('/api/admin/forum/sensitive-word/detect/highest-level', params);
  }
