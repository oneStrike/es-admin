...
import type {
   ...
   * 分页查询 APP 用户混合成长流水
   */
  export async function appUsersGrowthRecordPageApi(params: AppUsersGrowthRecordPageRequest): Promise<AppUsersGrowthRecordPageResponse> {
    return requestClient.get<AppUsersGrowthRecordPageResponse>('/api/admin/app-users/growth/record/page', { params });
  }
