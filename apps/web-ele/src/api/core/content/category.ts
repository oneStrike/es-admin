 ...
 * 分类交换排序
 */
export async function categorySwapSortOrderApi(
  params: CategorySwapSortOrderRequest,
): Promise<CategorySwapSortOrderResponse> {
  return requestClient.post<CategorySwapSortOrderResponse>(
