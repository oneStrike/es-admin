 ...
 * 更新作者推荐状态
 */
export async function authorUpdateIsRecommendedApi(
  params: AuthorUpdateIsRecommendedRequest,
): Promise<AuthorUpdateIsRecommendedResponse> {
  return requestClient.post<AuthorUpdateIsRecommendedResponse>(
    '/api/admin/work/author/update-isRecommended',
    params,
  );
}
