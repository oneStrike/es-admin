 ...
 * 更新漫画发布状态
 */
export async function comicUpdateStatusApi(
  params: ComicUpdateStatusRequest,
): Promise<ComicUpdateStatusResponse> {
  return requestClient.post<ComicUpdateStatusResponse>(
    '/api/admin/work/comic/update-status',
    params,
  );
}
 ...
 * 更新漫画推荐状态
 */
export async function comicUpdateRecommendedApi(
  params: ComicUpdateRecommendedRequest,
): Promise<ComicUpdateRecommendedResponse> {
  return requestClient.post<ComicUpdateRecommendedResponse>(
    '/api/admin/work/comic/update-recommended',
    params,
  );
}
 ...
 * 更新漫画热门状态
 */
export async function comicUpdateHotApi(
  params: ComicUpdateHotRequest,
): Promise<ComicUpdateHotResponse> {
  return requestClient.post<ComicUpdateHotResponse>(
    '/api/admin/work/comic/update-hot',
    params,
  );
}
 ...
 * 更新漫画新作状态
 */
export async function comicUpdateNewApi(
  params: ComicUpdateNewRequest,
): Promise<ComicUpdateNewResponse> {
  return requestClient.post<ComicUpdateNewResponse>(
    '/api/admin/work/comic/update-new',
    params,
  );
}
