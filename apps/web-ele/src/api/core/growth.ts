 ...
 * 获取积分规则分页
 */
export async function growthPointsRulesPageApi(
  params?: GrowthPointsRulesPageRequest,
): Promise<GrowthPointsRulesPageResponse> {
  return requestClient.get<GrowthPointsRulesPageResponse>(
    '/api/admin/growth/points-rules/page',
    { params },
  );
}
 ...
 * 获取积分规则详情
 */
export async function growthPointsRulesDetailApi(
  params: GrowthPointsRulesDetailRequest,
): Promise<GrowthPointsRulesDetailResponse> {
  return requestClient.get<GrowthPointsRulesDetailResponse>(
    '/api/admin/growth/points-rules/detail',
    { params },
  );
}
 ...
 * 创建积分规则
 */
export async function growthPointsRulesCreateApi(
  params: GrowthPointsRulesCreateRequest,
): Promise<GrowthPointsRulesCreateResponse> {
  return requestClient.post<GrowthPointsRulesCreateResponse>(
    '/api/admin/growth/points-rules/create',
    params,
  );
}
 ...
 * 更新积分规则
 */
export async function growthPointsRulesUpdateApi(
  params: GrowthPointsRulesUpdateRequest,
): Promise<GrowthPointsRulesUpdateResponse> {
  return requestClient.post<GrowthPointsRulesUpdateResponse>(
    '/api/admin/growth/points-rules/update',
    params,
  );
}
 ...
 * 获取用户经验规则分页
 */
export async function growthExperienceRulesPageApi(
  params?: GrowthExperienceRulesPageRequest,
): Promise<GrowthExperienceRulesPageResponse> {
  return requestClient.get<GrowthExperienceRulesPageResponse>(
    '/api/admin/growth/experience-rules/page',
    { params },
  );
}
 ...
 * 获取用户经验规则详情
 */
export async function growthExperienceRulesDetailApi(
  params: GrowthExperienceRulesDetailRequest,
): Promise<GrowthExperienceRulesDetailResponse> {
  return requestClient.get<GrowthExperienceRulesDetailResponse>(
    '/api/admin/growth/experience-rules/detail',
    { params },
  );
}
 ...
 * 创建用户经验规则
 */
export async function growthExperienceRulesCreateApi(
  params: GrowthExperienceRulesCreateRequest,
): Promise<GrowthExperienceRulesCreateResponse> {
  return requestClient.post<GrowthExperienceRulesCreateResponse>(
    '/api/admin/growth/experience-rules/create',
    params,
  );
}
 ...
 * 更新用户经验规则
 */
export async function growthExperienceRulesUpdateApi(
  params: GrowthExperienceRulesUpdateRequest,
): Promise<GrowthExperienceRulesUpdateResponse> {
  return requestClient.post<GrowthExperienceRulesUpdateResponse>(
    '/api/admin/growth/experience-rules/update',
    params,
  );
}
 ...
 * 删除用户经验规则
 */
export async function growthExperienceRulesDeleteApi(
  params: GrowthExperienceRulesDeleteRequest,
): Promise<GrowthExperienceRulesDeleteResponse> {
  return requestClient.post<GrowthExperienceRulesDeleteResponse>(
    '/api/admin/growth/experience-rules/delete',
    params,
  );
}
 ...
 * 增加用户经验
 */
export async function growthExperienceRulesGrantApi(
  params: GrowthExperienceRulesGrantRequest,
): Promise<GrowthExperienceRulesGrantResponse> {
  return requestClient.post<GrowthExperienceRulesGrantResponse>(
    '/api/admin/growth/experience-rules/grant',
    params,
  );
}
 ...
 * 获取用户经验记录分页
 */
export async function growthExperienceRulesRecordPageApi(
  params: GrowthExperienceRulesRecordPageRequest,
): Promise<GrowthExperienceRulesRecordPageResponse> {
  return requestClient.get<GrowthExperienceRulesRecordPageResponse>(
 ...
 * 获取用户经验记录详情
 */
export async function growthExperienceRulesRecordDetailApi(
  params: GrowthExperienceRulesRecordDetailRequest,
): Promise<GrowthExperienceRulesRecordDetailResponse> {
  return requestClient.get<GrowthExperienceRulesRecordDetailResponse>(
 ...
 * 获取用户经验统计信息
 */
export async function growthExperienceRulesStatsApi(
  params: GrowthExperienceRulesStatsRequest,
): Promise<GrowthExperienceRulesStatsResponse> {
  return requestClient.get<GrowthExperienceRulesStatsResponse>(
    '/api/admin/growth/experience-rules/stats',
    { params },
  );
}
