...
export async function reportPageApi(
  ...
  return requestClient.get<ReportPageResponse>('/api/admin/report/page', {
    params,
  });
}
...
export async function reportDetailApi(
  ...
  return requestClient.get<ReportDetailResponse>('/api/admin/report/detail', {
    params,
  });
}
