 ...
 * 根据ID查询页面配置详情
 */
export async function appPageDetailApi(
  params: AppPageDetailRequest,
): Promise<AppPageDetailResponse> {
  return requestClient.get<AppPageDetailResponse>(
    '/api/admin/app-page/detail',
    { params },
  );
}
 ...
 * 根据页面编码查询页面配置详情
 */
export async function appPageCodeDetailApi(
  params: AppPageCodeDetailRequest,
): Promise<AppPageCodeDetailResponse> {
  return requestClient.get<AppPageCodeDetailResponse>(
    '/api/admin/app-page/code/detail',
    { params },
  );
}
 ...
 * 批量下线页面配置
 */
export async function appPageDeleteApi(
  params: AppPageDeleteRequest,
): Promise<AppPageDeleteResponse> {
  return requestClient.post<AppPageDeleteResponse>(
    '/api/admin/app-page/delete',
    params,
  );
}
