 ...
 * 根据页面编码查询页面配置详情
 */
export async function appPageDetailCodeApi(
  params: AppPageDetailCodeRequest,
): Promise<AppPageDetailCodeResponse> {
  return requestClient.get<AppPageDetailCodeResponse>(
