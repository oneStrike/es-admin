 ...
 * 分页查询任务领取记录
 */
export async function taskAssignmentPageApi(
  params?: TaskAssignmentPageRequest,
): Promise<TaskAssignmentPageResponse> {
  return requestClient.get<TaskAssignmentPageResponse>(
    '/api/admin/task/assignment/page',
    { params },
  );
}
