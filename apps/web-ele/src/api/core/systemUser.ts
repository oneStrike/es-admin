 ...
 * 更新用户信息
 */
export async function systemUserProfileUpdateApi(
  params: SystemUserProfileUpdateRequest,
): Promise<SystemUserProfileUpdateResponse> {
  return requestClient.post<SystemUserProfileUpdateResponse>(
 ...
 * 修改密码
 */
export async function systemUserPasswordChangeApi(
  params: SystemUserPasswordChangeRequest,
): Promise<SystemUserPasswordChangeResponse> {
  return requestClient.post<SystemUserPasswordChangeResponse>(
...
): Promise<SystemUserPasswordResetResponse> {
  return requestClient.post<SystemUserPasswordResetResponse>(
