...
import type {
   ...
   * 批量启用禁用字典
   */
  export async function dictionaryBatchUpdateStatusApi(params: DictionaryBatchUpdateStatusRequest): Promise<DictionaryBatchUpdateStatusResponse> {
    return requestClient.post<DictionaryBatchUpdateStatusResponse>('/api/admin/dictionary/batch-update-status', params);
  }
  ...
  export async function dictionaryItemsApi(params: DictionaryItemsRequest): Promise<DictionaryItemsResponse> {
    return requestClient.get<DictionaryItemsResponse>('/api/admin/dictionary/items', { params });
  }
   ...
   * 创建字典项
   */
  export async function dictionaryCreateItemApi(params: DictionaryCreateItemRequest): Promise<DictionaryCreateItemResponse> {
    return requestClient.post<DictionaryCreateItemResponse>('/api/admin/dictionary/create-item', params);
  }
   ...
   * 更新字典项
   */
  export async function dictionaryUpdateItemApi(params: DictionaryUpdateItemRequest): Promise<DictionaryUpdateItemResponse> {
    return requestClient.post<DictionaryUpdateItemResponse>('/api/admin/dictionary/update-item', params);
  }
   ...
   * 删除字典项
   */
  export async function dictionaryDeleteItemApi(params: DictionaryDeleteItemRequest): Promise<DictionaryDeleteItemResponse> {
    return requestClient.post<DictionaryDeleteItemResponse>('/api/admin/dictionary/delete-item', params);
  }
   ...
   * 启用禁用字典项
   */
  export async function dictionaryUpdateItemStatusApi(params: DictionaryUpdateItemStatusRequest): Promise<DictionaryUpdateItemStatusResponse> {
    return requestClient.post<DictionaryUpdateItemStatusResponse>('/api/admin/dictionary/update-item-status', params);
  }
   ...
   * 分类拖拽排序
   */
  export async function dictionaryItemOrderApi(params: DictionaryItemOrderRequest): Promise<DictionaryItemOrderResponse> {
    return requestClient.post<DictionaryItemOrderResponse>('/api/admin/dictionary/item-order', params);
  }
