...
import type {
  ...
  export async function roleTypeListApi(): Promise<RoleTypeListResponse> {
    return requestClient.get<RoleTypeListResponse>('/api/admin/work/author/role-type/list');
  }
  ...
  export async function roleTypeCreateApi(): Promise<RoleTypeCreateResponse> {
    return requestClient.post<RoleTypeCreateResponse>('/api/admin/work/author/role-type/create');
  }
  ...
  export async function roleTypeDeleteApi(): Promise<RoleTypeDeleteResponse> {
    return requestClient.post<RoleTypeDeleteResponse>('/api/admin/work/author/role-type/delete');
  }
  ...
  export async function roleTypeUpdateApi(): Promise<RoleTypeUpdateResponse> {
    return requestClient.post<RoleTypeUpdateResponse>('/api/admin/work/author/role-type/update');
  }
  ...
  export async function roleTypeChangeStatusApi(): Promise<RoleTypeChangeStatusResponse> {
    return requestClient.post<RoleTypeChangeStatusResponse>('/api/admin/work/author/role-type/change-status');
  }
