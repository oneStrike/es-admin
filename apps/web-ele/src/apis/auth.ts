...
import type {
   ...
   * 刷新访问令牌
   */
  export async function authRefreshTokenApi(params: AuthRefreshTokenRequest): Promise<AuthRefreshTokenResponse> {
    return requestClient.post<AuthRefreshTokenResponse>('/api/admin/auth/refresh-token', params);
  }
