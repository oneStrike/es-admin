...
import type {
  ...
  export async function thirdPartyPlatformApi(): Promise<ThirdPartyPlatformResponse> {
    return requestClient.get<ThirdPartyPlatformResponse>('/api/admin/work/comic/third-party/platform');
  }
  ...
  export async function thirdPartySearchApi(params: ThirdPartySearchRequest): Promise<ThirdPartySearchResponse> {
    return requestClient.get<ThirdPartySearchResponse>('/api/admin/work/comic/third-party/search', { params });
  }
