...
import type {
   ...
   * 批量更新分类状态
   */
  export async function categoryBatchUpdateStatusApi(params: CategoryBatchUpdateStatusRequest): Promise<CategoryBatchUpdateStatusResponse> {
    return requestClient.post<CategoryBatchUpdateStatusResponse>('/api/admin/work/category/batch-update-status', params);
  }
   ...
   * 批量删除分类
   */
  export async function categoryBatchDeleteApi(params: CategoryBatchDeleteRequest): Promise<CategoryBatchDeleteResponse> {
    return requestClient.post<CategoryBatchDeleteResponse>('/api/admin/work/category/batch-delete', params);
  }
