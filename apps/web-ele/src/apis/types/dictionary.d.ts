 ...
 *  @更新时间 2026-01-03 01:08:16
 */
export type DictionaryBatchUpdateStatusRequest = BatchUpdateEnabledStatusDto;
...
/**
 *  类型定义 [BatchUpdateEnabledStatusDto]
 *  @来源 components.schemas
 *  @更新时间 2026-01-03 01:08:16
 */
export type BatchUpdateEnabledStatusDto = {
  /** 任意合法数值 */
  [property: string]: any;
  /* 主键id集合 */
  ids: number[];
