...
import { agreementPageApi } from '#/api/core';
...
export type VipPageConfigRow = NonNullable<
  MonetizationVipPageConfigPageResponse['list']
>[number] & {
...
function buildVipPageConfigBase(values: VipPageConfigFormValues) {
  ...
  } satisfies MonetizationVipPageConfigCreateRequest;
}
...
export function buildVipPageConfigUpdatePayload(
  ...
  } satisfies MonetizationVipPageConfigUpdateRequest;
}
