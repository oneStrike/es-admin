...
import {
  monetizationCurrencyPackageCreateApi,
  monetizationCurrencyPackagePageApi,
  monetizationCurrencyPackageUpdateApi,
  monetizationCurrencyPackageUpdateStatusApi,
} from '#/api/core';
  ...
  proxyConfig: {
    ajax: {
      query: async (
        ...
        await monetizationCurrencyPackagePageApi(
          formatQuery({
            page,
...
function buildCurrencyPackageSearchValues(
  ...
  return {
    ...
    startDate,
  } satisfies Partial<MonetizationCurrencyPackagePageRequest>;
}
...
async function handleCreateSubmit(values: CurrencyPackageFormValues) {
  await monetizationCurrencyPackageCreateApi(
...
async function handleEditSubmit(values: CurrencyPackageFormValues) {
  await monetizationCurrencyPackageUpdateApi(
...
async function toggleEnableStatus(row: CurrencyPackageRow) {
  ...
  try {
    await monetizationCurrencyPackageUpdateStatusApi({
      id: row.id,
      isEnabled: row.isEnabled !== true,
    } satisfies MonetizationCurrencyPackageUpdateStatusRequest);
