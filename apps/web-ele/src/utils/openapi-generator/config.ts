...
export const defaultConfig: OpenAPIGeneratorConfig = {
  ...
  legacyTypeAliases: {
    BaseAuthorDto: 'AuthorOutputBaseDto',
    BaseAppConfigDto: 'AppConfigOutputDto',
    BaseAppPageDto: 'AppPageOutputDto',
    BaseCategoryDto: 'CategoryOutputDto',
    BaseCouponDefinitionDto: 'CouponDefinitionOutputDto',
    BaseDictionaryDto: 'DictionaryOutputDto',
    BaseDictionaryItemDto: 'DictionaryItemOutputDto',
    BaseEmojiAssetDto: 'EmojiAssetOutputDto',
    BaseEmojiPackDto: 'EmojiPackOutputDto',
    BaseForumHashtagDto: 'AdminForumHashtagDto',
    BaseForumSectionDto: 'AdminForumSectionDto',
    BaseForumSectionGroupDto: 'ForumSectionGroupOutputDto',
    BaseGrowthRewardRuleDto: 'GrowthRewardRuleOutputDto',
    BaseMembershipBenefitDefinitionDto: 'MembershipBenefitDefinitionOutputDto',
    BaseSensitiveWordDto: 'SensitiveWordOutputDto',
    BaseSystemConfigDto: 'SystemConfigDetailDto',
    BaseUserBadgeDto: 'UserBadgeOutputDto',
    BaseUserLevelRuleDto: 'UserLevelRuleOutputDto',
    CreateAppUpdateReleaseDto: 'AppUpdateReleaseWriteDto',
    ForumModeratorLifecycleLogDto: 'BaseForumModeratorLifecycleLogDto',
    GrowthRewardSettlementPageItemDto: 'BaseGrowthRewardSettlementDto',
    TaskEventFailurePageItemDto: 'BaseTaskEventFailureDto',
    TaskInstanceViewDto: 'AdminTaskInstancePageItemDto',
  },
